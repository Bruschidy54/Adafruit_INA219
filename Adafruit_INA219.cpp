...
void Adafruit_INA219::setCalibration_Sunkara() {
  ...
  // VBUS_MAX = 30V?
  // VSHUNT_MAX = 0.3         Assumes Gain ~8, 300mV
  ...
  // 2. Determine max expected current
  // MaxExpected_I = 0.005A

  // 3. Calculate possible range of LSBs (Min = 15-bit, Max = 12-bit)
  // MinimumLSB = MaxExpected_I/32767
  // MinimumLSB = 0.00000015              (0.15uA per bit)
  // MaximumLSB = MaxExpected_I/4096
  // MaximumLSB = 0.00000122              (1.22uA per bit)
  ...
  //
  // Max_Current_Before_Overflow = MaxPossible_I
  // Max_Current_Before_Overflow = 0.03A
  //
  // Max_ShuntVoltage = Max_Current_Before_Overflow * RSHUNT
  // Max_ShuntVoltage = 0.3V
  //
  // If Max_ShuntVoltage >= VSHUNT_MAX
  //    Max_ShuntVoltage_Before_Overflow = VSHUNT_MAX
  // Else
  ...
  //
  // Max_ShuntVoltage_Before_Overflow = VSHUNT_MAX
  // Max_ShuntVoltage_Before_Overflow = 0.3V

  // 8. Compute the Maximum Power
  // MaximumPower = Max_Current_Before_Overflow * VBUS_MAX
  // MaximumPower = 0.03A * 30V
  // MaximumPower = 0.9W

  // Set multipliers to convert raw current/power values
  ina219_currentDivider_mA = 1000;    // Current LSB = 1uA per bit (1000/1 = 1000)
  ina219_powerMultiplier_mW = 0.02f; // Power LSB = 0.02mW per bit
